...
export const STRINGS = {
  it: {
    ...
    like: "Mi piace", likes: (n) => n === 1 ? "1 like" : `${n} like`,
    comment: "Commenta", comments: (n) => n === 1 ? "1 commento" : `${n} commenti`,
    ...
    sAccount: "Account", sEditProfile: "Modifica profilo", sChangePw: "Cambia password", sEmail: "Indirizzo email", sInvite: "Invita un amico",
    inviteText: "Ciao! Ti invito su Our Dates, l'app per condividere le date che contano. Unisciti qui:",
    inviteCopied: "Messaggio copiato negli appunti ✓",
  ...
  en: {
    ...
    like: "Like", likes: (n) => n === 1 ? "1 like" : `${n} likes`,
    comment: "Comment", comments: (n) => n === 1 ? "1 comment" : `${n} comments`,
    ...
    settings: "Settings",
    sAccount: "Account", sEditProfile: "Edit profile", sChangePw: "Change password", sEmail: "Email address", sInvite: "Invite a friend",
    inviteText: "Hey! I'm inviting you to Our Dates, the app for sharing the dates that matter. Join here:",
    inviteCopied: "Message copied to clipboard ✓",
  ...
  es: {
    ...
    like: "Me gusta", likes: (n) => n === 1 ? "1 me gusta" : `${n} me gusta`,
    comment: "Comentar", comments: (n) => n === 1 ? "1 comentario" : `${n} comentarios`,
    ...
    settings: "Ajustes",
    sAccount: "Cuenta", sEditProfile: "Editar perfil", sChangePw: "Cambiar contraseña", sEmail: "Correo electrónico", sInvite: "Invitar a un amigo",
    inviteText: "¡Hola! Te invito a Our Dates, la app para compartir las fechas que importan. Únete aquí:",
    inviteCopied: "Mensaje copiado al portapapeles ✓",
